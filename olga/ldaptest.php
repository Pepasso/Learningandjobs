...
<form action='<?=$_SERVER["PHP_SELF"]?>' method="post">
	...
	<tr>
		...
		<td colspan="2">
			...
			<input type="checkbox" onchange="showpass();" name="check_pass" <?if(isset($_POST["check_pass"])) echo 'checked';?>>������
		</td>
	</tr>
	<tr>
		<td>BaseDN</td>
		...
		<td>
			...
			<input type="submit" name="BaseDN" value="�������� BaseDN" />
	...
	<tr>
		...
		<td>
			<a href="javascript:void(0);" onclick="javascript:check(this);" id="a_user">|&nbsp;������������&nbsp;|&nbsp;</a>
			<a href="javascript:void(0);" onclick="javascript:check(this);" id="a_group">������&nbsp;|&nbsp;</a>
			<a href="javascript:void(0);" onclick="javascript:check(this);" id="a_other">����&nbsp;|&nbsp;</a>
		</td>
	</tr>
	<tr>
		<td>��������� ����</td>
		...
		<td>
			<a href="javascript:void(0);" onclick="document.getElementById('ad_fields').value=''">��������</a>
		</td>
	</tr>
	<tr><td><input type="submit" name="exec" value="���������"></td></tr>
	</table>
